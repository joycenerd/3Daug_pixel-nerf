...
def extra_args(parser):
    parser.add_argument(
        "--batch_size", "-B", type=int, default=12, help="Object batch size ('SB')"
    )
    parser.add_argument(
        "--nviews",
        "-V",
...
dset, test_dset = get_split_dataset(args.dataset_format, args.datadir)
print(
...
class PixelNeRFTrainer(trainlib.Trainer):
    def __init__(self):
        ...
        super().__init__(net, dset,test_dset, args, conf["train"], device=device)
