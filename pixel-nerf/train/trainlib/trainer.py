...
class Trainer:
    def __init__(self, net, train_dataset, test_dataset, args, conf, device=None):
        ...
        self.summary_path = os.path.join(args.save_dir,args.name,args.logs_path)
        ...
        self.visual_path = os.path.join(self.args.save_dir,self.args.name,self.args.visual_path)
        self.conf = conf
